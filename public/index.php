...
$host = getenv('DB_HOST'); // <-- PENTING: Gunakan nama service 'db' sebagai host
...
try {
    ...
    $db_status = "Sukses terhubung ke database MySQL!";
    $db_class = "bg-green-100 text-green-700";
} catch(PDOException $e) {
    $db_status = "Gagal terhubung ke database: " . $e->getMessage();
    $db_class = "bg-red-100 text-red-700";
}
?>
